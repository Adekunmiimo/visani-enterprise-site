    ...
    <>
          ...
          <div className="grid items-center gap-20 lg:grid-cols-2">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="mt-6 text-5xl font-semibold tracking-tight text-white sm:text-6xl">
                A.R.I.S.E.X™
                <span className="block text-white/85">Governed AI Execution at Scale</span>
              </h1>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="relative mx-auto max-w-5xl rounded-[32px] bg-white/95 px-16 py-20 backdrop-blur-sm shadow-[0_45px_140px_-40px_rgba(0,0,0,0.25)] ring-1 ring-black/5">
            ...
            <h2 className="mt-7 text-center text-[3rem] leading-tight font-semibold tracking-tight text-brand-slate">
              ...
              <span className="block text-brand-slate/75">It breaks at the operating layer.</span>
            </h2>

            <p className="mx-auto mt-10 max-w-4xl text-center text-[1.125rem] leading-relaxed text-brand-muted">
              Enterprises consistently demonstrate AI value in pilots. Breakdown occurs when experimental
              success meets real operating conditions where ownership is unclear, workflows are misaligned,
              governance is reactive, and value cannot be defended at scale.
            </p>
          ...
          <div className="mt-24 grid gap-14 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              >
                ...
                <p className="mt-6 max-w-[22rem] text-sm leading-relaxed text-white/65">{desc}</p>
          ...
          <div className="grid gap-20 lg:grid-cols-[1fr_1fr] lg:items-start">
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-base leading-relaxed text-brand-muted">
                This cadence creates decision clarity, reduces execution risk, and ensures AI value
                remains visible, defensible, and aligned to enterprise priorities over time.
              </p>
            </div>
            ...
            <div className="relative rounded-3xl border border-brand-border bg-brand-offwhite px-12 py-14 shadow-sm">
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-start gap-4">
                  <span className="mt-1 h-2.5 w-2.5 rounded-full bg-brand-slate/60" />
                  <p className="text-base leading-relaxed text-brand-muted">
                    <span className="font-semibold text-brand-slate">Delivery cycles</span>{" "}
                    anchored to workflow outcomes and business impact not model demos or experimental
                    releases.
                  </p>
                </li>
                ...
                <li className="flex items-start gap-4">
                  <span className="mt-1 h-2.5 w-2.5 rounded-full bg-brand-slate/60" />
                  <p className="text-base leading-relaxed text-brand-muted">
                    <span className="font-semibold text-brand-slate">Governance reviews</span>{" "}
                    aligned to enterprise risk, compliance requirements, and scaling thresholds.
                  </p>
                </li>
                ...
                <li className="flex items-start gap-4">
                  <span className="mt-1 h-2.5 w-2.5 rounded-full bg-brand-slate/60" />
                  <p className="text-base leading-relaxed text-brand-muted">
                    <span className="font-semibold text-brand-slate">Measurement reviews</span>{" "}
                    that surface value clearly and allow leaders to defend impact to boards,
        ...
        <div className="mx-auto max-w-7xl px-6 py-36">
          <div className="grid gap-20 lg:grid-cols-[1fr_1fr] lg:items-start">
            <div className="max-w-xl">
              ...
              <p className="mt-8 text-lg leading-relaxed text-brand-muted">
                A.R.I.S.E.X™ was intentionally designed to avoid the common patterns that stall
                enterprise AI efforts after early success.
              </p>

              <p className="mt-6 text-base leading-relaxed text-brand-muted">
                This clarity matters because leaders need to know exactly what they are and are not
                committing to when they operationalize AI at scale.
              </p>
            </div>
            ...
            <div className="relative rounded-3xl border border-brand-border bg-white px-14 py-16 shadow-sm">
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <p className="text-base leading-relaxed text-brand-muted">
                    ...
                    designed to sell technology rather than improve enterprise execution.
                  </p>
                </li>
              ...
              <p className="mt-10 text-base leading-relaxed text-brand-muted">
                A.R.I.S.E.X™ is a governed execution system leaders operate continuously as AI becomes
                embedded into how the enterprise actually runs.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 py-24">
          <div className="relative z-10 mx-auto max-w-3xl rounded-[28px] border border-white/15 bg-white/10 backdrop-blur-xl shadow-[0_55px_120px_-45px_rgba(0,0,0,0.75)] px-8 py-10 sm:px-12 sm:py-12 lg:px-14 lg:py-14">
            ...
            <h2 className="mt-5 text-2xl font-semibold tracking-tight text-white sm:text-3xl">
              Ready to govern AI
              <span className="block text-white/85">at enterprise scale?</span>
            </h2>

            <p className="mt-6 max-w-2xl text-base leading-relaxed text-white/75">
              If your organization is moving beyond pilots, A.R.I.S.E.X™ provides the operating
              discipline required to scale AI with confidence, governance, and defensible impact
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <ButtonLink href="/arisex" variant="secondary" className="px-9 py-3.5 text-sm">
                Explore A.R.I.S.E.X™
              </ButtonLink>
            </div>
