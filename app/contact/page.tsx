...
export default function ContactPage() {
  return (
    <>
      {/* ================= CONTACT HERO (EXECUTIVE, IMAGE-LED) ================= */}
      <Section
        className="relative overflow-hidden"
        style={{
          backgroundImage: "url('/contact-hero-bg.jpg')", // architectural, enterprise-grade
          backgroundSize: "cover",
          backgroundPosition: "center",
          backgroundRepeat: "no-repeat",
        }}
      >
        {/* EXECUTIVE DEPTH & READABILITY */}
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-36">
          <div className="grid gap-24 lg:grid-cols-2 lg:items-center">
            ...
            {/* RIGHT   EXECUTIVE SIGNAL IMAGE */}
            <div className="relative hidden lg:block">
              <div className="relative aspect-[4/5] overflow-hidden rounded-[32px] border border-black/10 shadow-[0_60px_160px_-55px_rgba(0,0,0,0.3)]">
                <Image
                  src="/contact-executive.jpg" // executive receptionist receiving a call
              ...
              {/* Micro-caption   restrained and credible */}
              <p className="mt-5 max-w-sm text-xs leading-relaxed text-brand-muted">
       ...
       {/* ================= WHAT TO EXPECT (EXECUTIVE WORKING SESSION) ================= */}
      <Section className="bg-brand-offwhite">
        <div className="mx-auto max-w-7xl px-6 py-36">
          <div className="grid gap-28 lg:grid-cols-2 lg:items-start">
            ...
            {/* RIGHT   SESSION STRUCTURE (EXECUTIVE CARD) */}
            <div
              className="
                relative
                rounded-[32px]
                ...
                px-20
                py-20
                shadow-[0_40px_100px_-35px_rgba(0,0,0,0.14)]
              "
            >
              ...
              {/* Bottom breathing space (intentional, not decorative) */}
      ...
      {/* ================= WHO THIS IS FOR (EXECUTIVE AUDIENCE) ================= */}
          ...
          <div className="mt-24 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="rounded-[30px] border border-brand-border bg-brand-offwhite px-12 py-16 text-center shadow-[0_25px_70px_-30px_rgba(0,0,0,0.12)]">
              ...
              <p className="mt-4 text-sm leading-relaxed text-brand-muted">
                Accountable for enterprise performance, strategic risk, and the
                long-term operating impact of AI decisions.
              </p>
            </div>
            ...
            <div className="rounded-[30px] border border-brand-border bg-brand-offwhite px-12 py-16 text-center shadow-[0_25px_70px_-30px_rgba(0,0,0,0.12)]">
              ...
              <p className="mt-4 text-sm leading-relaxed text-brand-muted">
                Responsible for scaling AI into core systems while maintaining
                reliability, control, and operational integrity.
              </p>
            </div>
            ...
            <div className="rounded-[30px] border border-brand-border bg-brand-offwhite px-12 py-16 text-center shadow-[0_25px_70px_-30px_rgba(0,0,0,0.12)]">
              ...
              <p className="mt-4 text-sm leading-relaxed text-brand-muted">
                Charged with ensuring AI adoption remains defensible, auditable, and
                aligned with regulatory and governance expectations.
              </p>
            </div>
            ...
            <div className="rounded-[30px] border border-brand-border bg-brand-offwhite px-12 py-16 text-center shadow-[0_25px_70px_-30px_rgba(0,0,0,0.12)]">
              ...
              <p className="text-base font-semibold text-brand-slate">
                Board & operating committees
              </p>

              <p className="mt-4 text-sm leading-relaxed text-brand-muted">
                Oversight bodies responsible for governance, value realization, and
                sustained accountability at enterprise scale.
              </p>
            </div>
      ...
      {/* ================= FINAL CTA (EXECUTIVE DECISION MOMENT) ================= */}
        <Section
          className="relative overflow-hidden"
          style={{
            backgroundImage: "url('/cta-executive-bg.jpg')", // architectural, neutral, executive
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundRepeat: "no-repeat",
          }}
          ...
          <div className="relative mx-auto max-w-7xl px-6 py-36">
            ...
            <div
              className="
                ...
                px-12 py-14
                text-center
                shadow-[0_60px_160px_-55px_rgba(0,0,0,0.85)]
              "
            >
              {/* GLOWING EXECUTIVE ICON */}
              ...
              <p className="mt-6 text-lg leading-relaxed text-white/90">
                ...
                provides clarity on whether it is truly governable at scale  
                before risk, scrutiny, or accountability force the issue.
              </p>
              ...
              {/* TRUST LINE */}
              <p className="mt-8 max-w-xl mx-auto text-sm leading-relaxed text-white/55">
                Briefings are confidential and structured for executive, board,
                and risk leadership audiences.
              </p>
            </div>
          </div>
        </Section>
