...
export default function InsightsPage() {
  return (
    ...
    <Section
      ...
      style={{
        backgroundImage: "url('/insights-hero-bg.jpg')",
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-3xl text-lg leading-relaxed text-white/75">
              Decision-grade perspectives for enterprise leaders responsible
              for scaling AI with control, accountability, and defensible outcomes.
            </p>

            <p className="mt-4 max-w-2xl text-base leading-relaxed text-white/65">
              Written for executives moving beyond experimentation and into
              real operating environments where governance, cadence, and
              incentives determine success.
            </p>
          </div>

          {/* RIGHT   CLASSY AUTOMOTIVE VISUAL */}
          <div className="relative hidden lg:block">
            ...
            <p className="mt-4 max-w-sm text-xs text-white/55">
              Precision, discipline, and control   the same standards executives apply to enterprise execution.
            </p>
          </div>
        ...
        <div className="grid gap-24 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-8 text-lg leading-relaxed text-brand-muted">
              ...
              forecasts. They are disciplined examinations of how AI actually behaves
              inside complex enterprises once pilots collide with real operating constraints.
            </p>

            <p className="mt-6 text-lg leading-relaxed text-brand-muted">
              Each brief is designed to support executive judgment in boardrooms,
              operating committees, risk reviews, and regulatory conversations where
              clarity, defensibility, and accountability matter.
            </p>
          </div>

          {/* RIGHT   EXECUTIVE SIGNAL PANEL (CORRECTED PADDING) */}
          <div
            className="
              relative
              rounded-[28px]
              ...
              bg-white
              shadow-[0_30px_90px_-35px_rgba(0,0,0,0.15)]
              px-10 py-12
              sm:px-12 sm:py-14
              lg:px-14 lg:py-16
            "
...
<Section
  className="relative overflow-hidden"
  style={{
    backgroundImage: "url('/insights-feed-bg.jpg')", // abstract, architectural, enterprise-safe
    backgroundSize: "cover",
    backgroundPosition: "center",
    backgroundRepeat: "no-repeat",
  }}
>
  {/* IMAGE CONTROL + READABILITY LAYERS */}
  ...
  <div className="relative mx-auto max-w-7xl px-6 py-32">
    ...
    <div className="max-w-4xl">
      ...
      <p className="mt-6 text-base leading-relaxed text-white/80">
        Published perspectives on enterprise AI execution, governance,
        and operating discipline written for leaders accountable for
        real-world outcomes.
      </p>
    </div>
      ...
      {[1, 2, 3].map((i) => (
        <a
          ...
          className="
            ...
            hover:-translate-y-1
            hover:bg-white/15
            hover:shadow-[0_45px_130px_-40px_rgba(0,0,0,0.7)]
          "
        >
          {/* Subtle top divider */}
          ...
          <p className="mt-6 text-sm leading-relaxed text-white/80">
            A structural analysis of where execution breaks when pilots
            collide with real enterprise operating conditions.
          </p>
